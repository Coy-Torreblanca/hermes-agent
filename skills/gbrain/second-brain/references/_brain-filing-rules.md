> **This is a reference file loaded via `skill_view()`.** All brain writes use Hermes MCP tools.
...
- **People:** Will you interact with them again? Are they relevant to your work or personal life?
